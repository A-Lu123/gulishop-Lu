                ...
                <div class="subitem">
                  <dl class="fore" v-for="(c2, index) in c1.categoryChild" :key="c2.categoryId">
                    ...
                    :data-category2Id = "c2.categoryId"
                      >{{c2.categoryName}}</a>
                       <!-- <a href="javascript:;" @click="$router.push({name:'search',query:{categoryName:c2categoryName,category2Id:c2.categoryId})">{{c2.categoryName}}</a> -->
                    </dt>
                    <dd>
...
export default {
  ...
  methods: {
    ...
    toSearch(e){
        ...
        let {categoryname,category1id,category12d,category3id} = data
        if(categoryname){
            let location = {
                name:'search'
            }
